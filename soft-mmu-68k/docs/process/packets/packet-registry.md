# SM68861 Legacy / Bootstrap Packet Registry

> **Frozen by PROC2A.** This file is retained as a historical/bootstrap snapshot and is **not** the live packet-status source.
>
> For packets created under the post-PROC2A process, query the controlling GitHub packet Issue plus linked PR/commit/CI evidence. Do not add new live-status rows here.

The rows below preserve the bounded historical bootstrap created by PROC1B, with the MTC1 and PROC1B closeout contradictions corrected by PROC2A.
...
| MTC1 | MATLAB TC/CRP single-level span reference model | Merged | TC1B (current-behavior boundary) | Project Lead + MMU MATLAB Toolchain Coach | `matlab/mtc1-tc-crp-span-reference` / [PR #40](https://github.com/patrick-welch/soft-mmu-68k/pull/40) | [MEMO-2026-001](../memoranda/MEMO-2026-001-mtc1-scope-and-sequencing.md); verified merged PR #40 | [MTC1 definition](MTC1-matlab-tc-crp-span-reference.md) | Merge commit `7b39bb2e0713bace15126f5d6e5af41300972ac7`. |
...
| PROC1B | Verified Packet and Briefing Record Bootstrap | Merged | PROC1A | MMU Documentation Manager | `docs/proc1b-verified-record-bootstrap` / [PR #39](https://github.com/patrick-welch/soft-mmu-68k/pull/39) | Project Lead release of approved PROC1B packet after source gate resolution; verified merged PR #39 | [PROC1B definition](PROC1B-verified-packet-and-briefing-record-bootstrap.md) | Merge commit `811f50cccfc8a096091d99d3288e9114076be215`. |

## Frozen scope

This snapshot remains intentionally bounded to the eight identities above. PROC2A is **not** added as a registry row. Historical omissions are not backfilled.

The live packet control plane after PROC2A is GitHub Issues. Existing packet files, PRs, commits, memoranda, and this snapshot remain historical evidence.
